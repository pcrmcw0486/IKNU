...
public class SEMINAR_Forum extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seminar__forum);
        ...
        *  db.collection("Location").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
        ...
        mdb.collection("SEMINAR").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if(task.isSuccessful())
                {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(SEMINAR_Forum.this, Forum_View.class);
                intent.putExtra("documentID", textID.get(position));
                intent.putExtra("documentName", "SEMINAR");
    ...
    public void onMove(View view) {
        ...
        {
            case R.id.Forum_btn :
                intent = new Intent(SEMINAR_Forum.this, Forum.class);
                startActivity(intent);
                finish();
                break;
            case R.id.Setting_btn :
                intent = new Intent(SEMINAR_Forum.this, Setting.class);
                startActivity(intent);
                finish();
                break;
            case R.id.Home_btn :
                intent = new Intent(SEMINAR_Forum.this, Home.class);
                startActivity(intent);
                finish();
            case R.id.makeText :
                intent = new Intent(SEMINAR_Forum.this, NewWrite_Forum.class);
                startActivity(intent);
                finish();
            default:
                return;
