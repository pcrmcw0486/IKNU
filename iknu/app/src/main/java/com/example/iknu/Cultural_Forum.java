...
public class Cultural_Forum extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cultural__forum);
        ...
        *  db.collection("Location").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
        ...
        mdb.collection("CULTURAL").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            @Override
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if(task.isSuccessful())
                {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(Cultural_Forum.this, Forum_View.class);
    ...
    public void onMove(View view) {
        ...
        {
            case R.id.Forum_btn :
                intent = new Intent(Cultural_Forum.this, Forum.class);
                startActivity(intent);
                finish();
                break;
            case R.id.Setting_btn :
                intent = new Intent(Cultural_Forum.this, Setting.class);
                startActivity(intent);
                finish();
                break;
            case R.id.Home_btn :
                intent = new Intent(Cultural_Forum.this, Home.class);
                startActivity(intent);
                finish();
            case R.id.makeText :
                intent = new Intent(Cultural_Forum.this, NewWrite_Forum.class);
                startActivity(intent);
                finish();
            default:
                return;
